...
$profession = [
    [
    	"main" => "Пастух / ВЛКСМОбрМобрСССРПромСберХоз",
    	"begin" => "Никогдабрь 1960",
        "description" => "Крутил хвосты",
    ],
    [
    	"main" => "Повар / Ладушки-Аладушки",
    	"begin" => "Переломай 1990",
        "description" => "Крутил блины",
    ],
    [
    	"main" => "Дискжокей / УльтраКот",
    	"begin" => "Ньююнь 2020",
        "description" => "Кручу пластинки",
    ],
    [
    	"main" => "",
    	"begin" => '<span class="w3-tag w3-teal w3-round">По текущее время</span>',
        "description" => "",
    ],
 ];
?>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
          <?php for ($i = count($profession)-2; $i >= 0; $i--): ?>
            <h5 class="w3-opacity"><b><?php echo $profession[$i]["main"] ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
            <?php echo $profession[$i]["begin"] ?> - <?php echo $profession[$i+1]["begin"] ?></h6>
            <p><?php echo $profession[$i]["description"] ?></p>
            <hr>
          <?php endfor; ?>
          </div>
